...
class Scheduler {
  ...
  isProviderAvailable() {
    ...
    let overlaps = _.reject(this.appointments, appointment => {
      ...
      console.log('existingApptStart:', existingApptStart.toString());
      console.log('existingApptEnd:', existingApptEnd.toString());
      console.log('newApptStart:', newApptStart.toString());
      console.log('newApptEnd:', newApptEnd.toString());
